    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <x-modal message="Are you sure to save changes ?" 
                        onConfirm="updateStudentData();"
                        title="Warning"
                        isCentered="false"
                        id="exampleModal"/>
                    ...
                    <x-modal message="Are you sure to save changes ?" title="Warning" id="contactModal" isCentered="false" onConfirm="updateContact();"/>
