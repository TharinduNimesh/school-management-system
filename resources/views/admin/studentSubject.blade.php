            ...
            <div class="modal fade" tabindex="-1" id="statusChangeModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>You can set a deadline for subject requests in the system settings. After the deadline,
                                the subject request feature
                                will be automatically deactivated. This will give you enough time to review and approve
                                or reject student requests
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn" style="background-color: #3457e3; color: white;"
                                onclick="activate(this);" id="actionButton">Confirm</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    ...
                    @if ($aesthetic == 'active')
                        <div class="col-md-4 col-12">
                            <div data-target="aesthetic"
                                class="task-active rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    @else
                        <div class="col-md-4 col-12">
                            <div data-target="aesthetic" onclick="changeStatus(this);"
                                class="task-deactive rounded d-flex align-items-center justify-content-between p-4">
                                <i class="fa fa-chart-line fa-3x text-primary"></i>
                                <div class="ms-3">
                                    <p class="mb-2 text-dark">Grade 6 Students</p>
                                    <h6 class="mb-0 text-dark">
                    ...
                    @else
                        <div class="col-md-4 col-12">
                            <div data-target="ol" onclick="changeStatus(this);"
                                class="task-deactive rounded d-flex align-items-center justify-content-between p-4">
                                <i class="fa fa-chart-line fa-3x text-primary"></i>
                                <div class="ms-3">
                                    <p class="mb-2 text-dark">Grade 10 Students (O/L)</p>
                    ...
                    @else
                        <div class="col-md-4 col-12">
                            <div data-target="al" onclick="changeStatus(this);"
                                class="task-deactive rounded d-flex align-items-center justify-content-between p-4">
                                <i class="fa fa-chart-line fa-3x text-primary"></i>
                                <div class="ms-3">
                                    <p class="mb-2 text-dark">Grade 12 Students (A/L)</p>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="mb-3 col-md-12 ">
                            ...
                            <select id="selectedGrade" onchange="changeGrade();"
                                class="form-select form-control form-select-lg text-dark bg-secondary mb-3"
                    ...
                    <div class="col-12">
                        <div class="h-100 bg-secondary rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0 text-dark">Considering the requests of students applying for Bucket
                                    subjects</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="mb-3 col-md-12" id="aestheticSubjectList">
                                        <sapn for="Namewithinitials" class="form-label text-dark">Filter In Subject
                                        </sapn>
                                        <select onchange="filterBySubject();"
                                            class="form-select form-select-lg text-dark bg-secondary mb-3"
                                            id="filteredSubjectList" aria-label=".form-select-lg example">
                                            <option selected = "0">Open this select menu</option>

                                        </select>
                                    </div>
                                    <div id="olSubjectList" class="row d-none">
                                        <div class="mb-3 col-md-4">
                                            <sapn for="Namewithinitials" class="form-label text-dark">Filter In
                                                Subject</sapn>
                                            <select name="bucketSubjectLists" onchange="filterByMultiSubject(this);"
                                                data-cell="2"
                                                class="form-select form-select-lg text-dark bg-secondary mb-3"
                                                id="bucket_1">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        <sapn for="Namewithinitials" class="form-label text-dark">Filter In Student
                                            Name</sapn>
                                        <input type="text" onkeyup="filterByName();" id="filteringName"
                                            class="form-control mt-1 text-dark bg-secondary"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($aestheticRequests as $key => $request)
                                                    <tr id="aesthetics{{ $request['_id'] }}">
                                                        ...
                                                        <td>
                                                            <button data-subject="{{ $request['subject'] }}"
                                                                data-category="aesthetics"
                                                                data-medium="{{ $request['medium'] }}"
                                                                onclick="action(this);" data-status="accept"
                                                        ...
                                                        <td>
                                                            <button data-subject="{{ $request['subject'] }}"
                                                                data-category="aesthetics"
                                                                data-medium="{{ $request['medium'] }}"
                                                                onclick="action(this);" data-status="reject"
                                                                data-index="{{ $request['index_number'] }}"
                                                                data-id="{{ $request['_id'] }}"
                                                ...
                                                @foreach ($olRequests as $key => $request)
                                                    <tr id="olRow{{ $request['_id'] }}">
                                                        ...
                                                        @php
                                                            ...
                                                            ${'OL' . $medium}++;
                                                        @endphp
                                                        <td><button onclick="getMarks(this);" class="btn btn-primary"
                                                                data-index="{{ $request['index_number'] }}">View</button>
                                                        </td>
                                                        <td>
                                                            <button
                                                                data-subject_1="{{ $request['subjects']['subject_1'] }}"
                                                                data-subject_2="{{ $request['subjects']['subject_2'] }}"
                                                                data-subject_3="{{ $request['subjects']['subject_3'] }}"
                                                                data-medium="{{ $request['medium'] }}"
                                                                data-index="{{ $request['index_number'] }}"
                                                                data-id="{{ $request['_id'] }}" data-type="accept"
                                                        ...
                                                        <td>
                                                            <button
                                                                ...
                                                                data-medium="{{ $request['medium'] }}"
                                                                data-index="{{ $request['index_number'] }}"
                                                                data-id="{{ $request['_id'] }}" data-type="reject"
                                                                onclick="actionOlSubject(this);"
                                                                class="btn btn-danger">Reject</button>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="d-none" id="gradeTwelveContainer">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="alTable">
                                            <thead class="table-dark">
                                                <tr>
                                                    <th scope="col">No</th>
                                                    <th scope="col">Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($alRequests as $key => $request)
                                                    <tr id="alRow{{ $request['_id'] }}">
                                                        ...
                                                        @endphp
                                                        @foreach ($request['subjects'] as $subject)
                                                            <td scope="col" class="space">{{ $subject }}
                                                            </td>
                                                        @endforeach
                                                        <td scope="col" class="space">{{ $request['medium'] }}
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-success px-2"
                                                                data-id="{{ $request['_id'] }}"
                                                                onclick="acceptAlRequest();">Approve</button>
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-danger px-2"
                                                                data-id="{{ $request['_id'] }}"
                                                                onclick="rejectAlRequest();">Reject</button>
                                                        </td>
                                                    </tr>
                                                    @php
                                                        $medium = $request['medium'];
    ...
    <script>
        ...
        function changeGrade() {
            ...
            if (grade.value == "0") {
                ...
                if ("{{ $artCount }}" == 0 && "{{ $westernMusicCount }}" == 0 && "{{ $eastenMusicCount }}" == 0 &&
                    "{{ $dancingCount }}" == 0 && "{{ $dramaCount }}" == 0) {
                    mediumContainer.classList.add("d-none");
                    subjectGraph.classList.add("d-none");
                } else {
                    options = {
                ...
                subjectList.classList.remove("d-none");
                aestheticsList.classList.remove("d-none");
                document.getElementById("filteredSubjectList").dataset.table = "alTable";
        ...
        function filterByName() {
            ...
            // Get the table element by its ID
            var table = document.getElementById(document.getElementById("filteredSubjectList").dataset.table);
        ...
        function acceptAlRequest() {
            var id = event.target.dataset.id;
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "{{ route('accept.al.request', ':id') }}".replace(':id', id));
            xhr.onload = function() {
                if (xhr.status == 200) {
                    var response = JSON.parse(xhr.responseText);
                    if (response.status == "success") {
