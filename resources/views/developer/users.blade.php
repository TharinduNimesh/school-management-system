      ...
      @include('developer.components.navbar')
            ...
            <div class="container-fluid pt-4 px-4" style="min-height: 80vh" >
                <div class="bg-secondary rounded h-100 p-3">
                    <h3 class="mb-4 text-primary">Add Users</h3>
                    <form class="row g-3 needs-validation" novalidate>
                      <div class="col-md-3">
                        <label for="validationCustom04" class="form-label">User Role</label>
                        <select class="form-select text-primary" name="role" id="validationCustom04" required>
                      ...
                      <div class="col-md-5">
                        ...
                        <div class="col-md-4">
                          ...
                          <input type="text" name="name" class="form-control text-primary" id="validationCustom02" value="" required>
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="input-group has-validation">
                            <input type="text" name="email" class="form-control text-primary" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="password" onkeyup="validatePassword();" name="password" id="userPassword" class="form-control text-primary" required>
                            <div class="invalid-feedback">
